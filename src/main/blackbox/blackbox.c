...
static const blackboxDeltaFieldDefinition_t blackboxMainFields[] = {
    ...
    */
    ...
    /* Named altitude-controller diagnostics.  The numeric prefix is
     * intentional: it keeps the fields in a stable, easy-to-follow order in
     * Blackbox viewers. */
    {"alt01_targetAltitude", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt02_actualAltitude", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt03_altitudeError", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt04_surfaceMode", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt05_surfaceStatus", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt06_rocMode", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt07_throttleZero", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt08_rcThrottle", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt09_rcThrottleAdjustment", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt10_climbRateDemand", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt11_targetClimbRate", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt12_actualClimbRate", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt13_velocityPidError", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt14_velocityPidP", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt15_velocityPidI", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt16_velocityPidD", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt17_velocityPidFF", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt18_velocityPidOutput", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt19_throttleOutput", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt20_surfacePidOutput", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt21_altitudeAdjusting", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
    {"alt22_altitudePidOutput", -1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), CONDITION(MC_NAV)},
     ...
     */
    {"gg_flag_navPosCtlReq",       -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlRun",       -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlBypass",    -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlDataNew",   -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlDataUsed",  -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlAdjusting", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlEstPosStatus", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlEstVelStatus", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_flag_navPosCtlEstHdgStatus", -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlEstPos",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlEstPos",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlEstPos",     2, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlEstVel",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlEstVel",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlEstVel",     2, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlEstAtt",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlEstAtt",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlEstAtt",     2, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlTgtPos",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlTgtPos",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlTgtPos",     2, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlDtMs",      -1, UNSIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlPosErr",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlPosErr",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlTgtVel",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlTgtVel",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlVelErr",     0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlVelErr",     1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},

    {"gg_navPosCtlAcc",        0, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
    {"gg_navPosCtlAcc",        1, SIGNED, .Ipredict = PREDICT(0), .Iencode = ENCODING(SIGNED_VB), .Ppredict = PREDICT(PREVIOUS), .Pencode = ENCODING(SIGNED_VB), FLIGHT_LOG_FIELD_CONDITION_NAV_POS},
...
typedef struct blackboxMainState_s {
    ...
    int16_t navSurface;
    int32_t altDebug[NAV_ALT_DEBUG_COUNT];
...
static void writeIntraframe(void)
{
    ...
    if (testBlackboxCondition(CONDITION(MC_NAV))) {
        for (int x = 0; x < NAV_ALT_DEBUG_COUNT; x++) {
            blackboxWriteSignedVB(blackboxCurrent->altDebug[x]);
        }
    }
...
static void writeInterframe(void)
{
    ...
    if (testBlackboxCondition(CONDITION(MC_NAV))) {
        blackboxWriteArrayUsingAveragePredictor32(offsetof(blackboxMainState_t, altDebug), NAV_ALT_DEBUG_COUNT);
    }
    ...
    /* Position-controller diagnostics. These fields are all encoded as one
     * signed variable-byte delta per field, matching their definitions above. */
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_NAV_POS)) {
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlRequested - blackboxLast->navPosCtlRequested);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlRun - blackboxLast->navPosCtlRun);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlBypass - blackboxLast->navPosCtlBypass);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlDataNew - blackboxLast->navPosCtlDataNew);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlDataConsumed - blackboxLast->navPosCtlDataConsumed);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlAdjusting - blackboxLast->navPosCtlAdjusting);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlEstPosStatus - blackboxLast->navPosCtlEstPosStatus);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlEstVelStatus - blackboxLast->navPosCtlEstVelStatus);
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlEstHeadingStatus - blackboxLast->navPosCtlEstHeadingStatus);
        for (int x = 0; x < XYZ_AXIS_COUNT; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlEstPosition[x] - blackboxLast->navPosCtlEstPosition[x]);
        }
        for (int x = 0; x < XYZ_AXIS_COUNT; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlEstVelocity[x] - blackboxLast->navPosCtlEstVelocity[x]);
        }
        for (int x = 0; x < XYZ_AXIS_COUNT; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlEstAttitude[x] - blackboxLast->navPosCtlEstAttitude[x]);
        }
        for (int x = 0; x < XYZ_AXIS_COUNT; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlTargetPosition[x] - blackboxLast->navPosCtlTargetPosition[x]);
        }
        blackboxWriteSignedVB(blackboxCurrent->navPosCtlUpdateDt - blackboxLast->navPosCtlUpdateDt);
        for (int x = 0; x < 2; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlPosError[x] - blackboxLast->navPosCtlPosError[x]);
        }
        for (int x = 0; x < 2; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlTargetVelocity[x] - blackboxLast->navPosCtlTargetVelocity[x]);
        }
        for (int x = 0; x < 2; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlVelocityError[x] - blackboxLast->navPosCtlVelocityError[x]);
        }
        for (int x = 0; x < 2; x++) {
            blackboxWriteSignedVB(blackboxCurrent->navPosCtlAcceleration[x] - blackboxLast->navPosCtlAcceleration[x]);
        }
        for (int x = 0; x < 2; x++) {
...
static void loadMainState(timeUs_t currentTimeUs)
{
    ...
    for (int i = 0; i < NAV_ALT_DEBUG_COUNT; i++) {
        blackboxCurrent->altDebug[i] = navAltitudeDebug[i];
    }
