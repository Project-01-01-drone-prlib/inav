...
#define DPS310_CS_PIN           PB3

// *************** I2C: Mag / external sensors ******
#define USE_I2C
...
// *************** Other ****************************
#define DEFAULT_FEATURES        (FEATURE_TX_PROF_SEL | FEATURE_OSD | FEATURE_TELEMETRY | FEATURE_CURRENT_METER | FEATURE_VBAT | FEATURE_BLACKBOX | FEATURE_LED_STRIP)
